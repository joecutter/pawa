...
module.exports = require("@ionic/cli-utils");

/***/ }),
/* 1 */
/***/ (function(module, exports, __webpack_require__) {

var baseAssign = __webpack_require__(105),
...
const xml2js = __webpack_require__(194);
const path = __webpack_require__(10);
const cli_utils_1 = __webpack_require__(0);
/**
 ...
 */
function getPlatformConfigJson(configJson, platform) {
    if (!configJson.widget.platform) {
        return;
    }
    return configJson.widget.platform.find((d) => {
        return d && d.$ && d.$.name === platform;
    });
}
exports.getPlatformConfigJson = getPlatformConfigJson;
/**
...
var escapeStringRegexp = __webpack_require__(87);
var ansiStyles = __webpack_require__(80);
var stripAnsi = __webpack_require__(190);
var hasAnsi = __webpack_require__(90);
var supportsColor = __webpack_require__(191);
...
function filterByIntent(metadata, options, intentName) {
...
function filterArgumentsForCordova(metadata, inputs, options) {
    const results = filterByIntent(metadata, options, exports.CORDOVA_INTENT);
  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent) {
      ...
      if (XMLElement === null) {
        ...
        XMLCData = __webpack_require__(63);
        XMLComment = __webpack_require__(64);
        XMLDeclaration = __webpack_require__(65);
        XMLDocType = __webpack_require__(66);
        XMLRaw = __webpack_require__(201);
        XMLText = __webpack_require__(203);
      }
    }
 ...
 */
function arePluginsInstalled(projectDir) {
    return __awaiter(this, void 0, void 0, function* () {
        let pluginDir = path.join(projectDir, 'plugins');
        let hasPlugins = false;
        try {
            yield cli_utils_1.fsReadDir(pluginDir);
            hasPlugins = true;
        }
        catch (ex) {
            hasPlugins = false;
...
exports.arePluginsInstalled = arePluginsInstalled;
/**
...
function installPlugins() {
    ...
    return Promise.all(plugins.map(plugin => (new cli_utils_1.Shell().run('cordova', ['plugin', 'add', '--save', plugin]))));
}
...
function installPlatform(platform) {
    return new cli_utils_1.Shell().run('cordova', ['platform', 'add', platform]);
}
...
const FormData = __webpack_require__(88);
const node_fetch_1 = __webpack_require__(208);
const cli_utils_1 = __webpack_require__(0);
const configXmlUtils_1 = __webpack_require__(4);
...
function flattenResourceJsonStructure(jsonStructure) {
    return flatten(Object.keys(jsonStructure).map(platform => (Object.keys(jsonStructure[platform]).map(resType => (jsonStructure[platform][resType]['images'].map((imgInfo) => ({
        platform,
        resType,
        name: imgInfo.name,
        width: imgInfo.width,
...
function getSourceImages(buildPlatforms, resourceTypes, resourceDir) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const srcImageDirContentList = yield Promise.all(srcDirList.map((srcImgDir) => cli_utils_1.fsReadDir(srcImgDir.path)));
        const sourceImages = flatten(srcImageDirContentList.map((srcImageDirContents, index) => (srcImageDirContents
            .map((imgName) => {
...
function uploadSourceImages(srcImages) {
    return __awaiter(this, void 0, void 0, function* () {
        return Promise.all(srcImages.map(function (srcImage) {
            return __awaiter(this, void 0, void 0, function* () {
                const form = new FormData();
                form.append('image_id', srcImage.imageId);
                form.append('src', fs.createReadStream(srcImage.path));
                try {
                    const response = yield node_fetch_1.default(UPLOAD_URL, {
                        method: 'POST',
                        body: form
                    });
...
function transformResourceImage(imageResource) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield node_fetch_1.default(TRANSFORM_URL, {
                method: 'POST',
                body: form
            });
            if (response.status !== 200) {
                const responseBody = yield streamToString(response.body);
                throw new Error(`STATUS: ${response.status} ${responseBody}`);
            }
            yield cli_utils_1.writeStreamToFile(response.body, imageResource.dest);
        }
        catch (e) {
            throw e;
        }
...
var abort = __webpack_require__(41)
...
(function() {
  ...
  XMLDTDAttList = __webpack_require__(197);

  XMLDTDEntity = __webpack_require__(199);

  XMLDTDElement = __webpack_require__(198);

  XMLDTDNotation = __webpack_require__(200);

  XMLProcessingInstruction = __webpack_require__(68);
...
(function() {
  ...
  every = __webpack_require__(178);

  XMLNode = __webpack_require__(9);

  XMLAttribute = __webpack_require__(195);
...
Object.defineProperty(exports, "__esModule", { value: true });
const cli_utils_1 = __webpack_require__(0);
const build_1 = __webpack_require__(71);
const compile_1 = __webpack_require__(72);
const emulate_1 = __webpack_require__(73);
const platform_1 = __webpack_require__(74);
const plugin_1 = __webpack_require__(75);
const prepare_1 = __webpack_require__(76);
const resources_1 = __webpack_require__(77);
const run_1 = __webpack_require__(78);
class CordovaNamespace extends cli_utils_1.Namespace {
    getCommands() {
        let m = new cli_utils_1.CommandMap();
        m.set('build', new build_1.BuildCommand());
        m.set('compile', new compile_1.CompileCommand());
        m.set('emulate', new emulate_1.EmulateCommand());
        m.set('platform', new platform_1.PlatformCommand());
        m.set('plugin', new plugin_1.PluginCommand());
        m.set('prepare', new prepare_1.PrepareCommand());
        m.set('resources', new resources_1.ResourcesCommand());
        m.set('run', new run_1.RunCommand());
        return m;
    }
}
...
const cli_utils_1 = __webpack_require__(0);
const cordova_1 = __webpack_require__(7);
const configXmlUtils_1 = __webpack_require__(4);
const setup_1 = __webpack_require__(15);
/**
 * Metadata about the build command
 */
let BuildCommand = class BuildCommand extends cli_utils_1.Command {
    run(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all([
                setup_1.getProjectPlatforms(this.env.project.directory).then((platforms) => {
                    if (!platforms.includes(runPlatform)) {
                        tasks.next(`Installing the platform: ${chalk.bold('cordova platform add ' + runPlatform)}`);
                        return setup_1.installPlatform(runPlatform);
                    }
                    return Promise.resolve();
                }),
                setup_1.arePluginsInstalled(this.env.project.directory).then((areInstalled) => {
                    if (!areInstalled) {
                        tasks.next(`Installing the project plugins: ${chalk.bold('cordova plugin add --save <plugin>')}`);
                        return setup_1.installPlugins();
                    }
                    return Promise.resolve();
                })
            ]);
            ...
            tasks.end();
            yield this.env.emitEvent('build', {
            ...
            yield this.env.shell.run('cordova', optionList, {
 ...
 */
let CompileCommand = class CompileCommand extends cli_utils_1.Command {
    run(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const tasks = new cli_utils_1.TaskChain();
            // ensure the content node was set back to its original
            yield configXmlUtils_1.resetConfigXmlContentSrc(this.env.project.directory);
            const optionList = cordova_1.gatherArgumentsForCordova(this.metadata, inputs, options);
            tasks.next(`Executing cordova command: ${chalk.bold('cordova ' + optionList.join(' '))}`);
            yield this.env.shell.run('cordova', optionList, {
                showExecution: (this.env.log.level === 'debug')
            });
 ...
 */
let EmulateCommand = class EmulateCommand extends cli_utils_1.Command {
    run(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            options = cli_utils_1.normalizeOptionAliases(this.metadata, options);
            ...
            if (!isLiveReload) {
                ...
                tasks.end();
                const serverSettings = yield this.env.emitEvent('serve', {
                    metadata: this.metadata,
                    inputs,
                    options: cordova_1.generateBuildOptions(this.metadata, options)
                });
                yield configXmlUtils_1.writeConfigXmlContentSrc(this.env.project.directory, `http://${serverSettings.ipAddress}:${serverSettings.httpPort}`);
...
const cordova_1 = __webpack_require__(7);
const configXmlUtils_1 = __webpack_require__(4);
const resources_1 = __webpack_require__(39);
/**
 * Metadata about the platform command
 */
let PlatformCommand = class PlatformCommand extends cli_utils_1.Command {
    prerun(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (inputs[0] === 'list') {
                const response = yield this.env.shell.run('cordova', [this.metadata.name, inputs[0]], {
                    showExecution: (this.env.log.level === 'debug')
                });
 ...
 * Metadata about the compile command
 */
let PluginCommand = class PluginCommand extends cli_utils_1.Command {
    run(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            let action = inputs[0];
            ...
            if (action === 'list') {
                try {
                    var response = yield this.env.shell.run('cordova', [this.metadata.name, action], {
                        showExecution: (this.env.log.level === 'debug')
                    });
            ...
            if (!pluginName) {
                const promptResults = yield this.env.inquirer.prompt({
 ...
 */
let PrepareCommand = class PrepareCommand extends cli_utils_1.Command {
    run(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            var tasks = new cli_utils_1.TaskChain();
            // ensure the content node was set back to its original src
    ...
    prerun(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!isLoggedIn) {
                ...
                yield cli_utils_1.promptToLogin(this.env.inquirer, this.env.log, this.env.session);
            }
        });
    }
    run(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let count = 0;
            const promiseList = imgResources.map((img, index) => {
                return resources_1.transformResourceImage(img).then(() => {
                    count += 1;
 ...
 */
let RunCommand = class RunCommand extends cli_utils_1.Command {
    run(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const isLiveReload = options['livereload'];
            const runPlatform = inputs[0];
...
module.exports =
{
  parallel      : __webpack_require__(83),
  serial        : __webpack_require__(84),
  serialOrdered : __webpack_require__(46)
};
...
var serialOrdered = __webpack_require__(46);
...
var Stream = __webpack_require__(37).Stream;
var DelayedStream = __webpack_require__(86);
...
var CombinedStream = __webpack_require__(85);
var util = __webpack_require__(38);
var path = __webpack_require__(10);
var http = __webpack_require__(206);
var https = __webpack_require__(207);
var parseUrl = __webpack_require__(211).parse;
var fs = __webpack_require__(69);
var mime = __webpack_require__(188);
var asynckit = __webpack_require__(81);
var populate = __webpack_require__(89);
...
var arrayEvery = __webpack_require__(99),
    baseEvery = __webpack_require__(108),
...
var db = __webpack_require__(187)
var extname = __webpack_require__(10).extname
...
;(function (sax) { // wrapper for non-node envs
  ...
  SAXStream.prototype.write = function (data) {
    if (typeof Buffer === 'function' &&
      ...
      if (!this._decoder) {
        var SD = __webpack_require__(209).StringDecoder
...
(function() {
  ...
  builder = __webpack_require__(204);
...
(function() {
  ...
  XMLBuilder = __webpack_require__(196);
...
exports.PLUGIN_NAME = 'cordova';
function run(envInstance) {
    return __awaiter(this, void 0, void 0, function* () {
        const cordovaNamespace = new commands_1.CordovaNamespace();
        yield cli_utils_1.runCommand(Object.assign({ namespace: cordovaNamespace }, envInstance));
    });
}
exports.run = run;
function getAllCommandMetadata() {
    const cordovaNamespace = new commands_1.CordovaNamespace();
    return cli_utils_1.getCommandMetadataList(cordovaNamespace);
}
exports.getAllCommandMetadata = getAllCommandMetadata;
